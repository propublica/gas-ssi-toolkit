...
| --- | --------------------------------------------- | ------------- | ----------- | ---------------------------------------------------- | ---- | ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | `docs/architecture.md`                        | Bounded       | Implemented | [AI-115](https://linear.app/propublica/issue/AI-115) | —    | —      | Add a pointer to `docs/plans/` and `docs/superpowers/specs/` as historical design-decision records — an archive, not maintained documentation.                                                                                                                                                                                                                                                                                                       |
